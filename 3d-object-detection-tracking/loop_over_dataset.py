...
results_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'results/darknet/results_sequence_1_darknet')
...
exec_detection = ['bev_from_pcl', 'detect_objects'] #['bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'] # options are 'bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'; options not in the list will be loaded from file
